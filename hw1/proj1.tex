...
\usepackage[a4paper,total={18cm,24.7cm},left=1.6cm,top=1.5cm]{geometry}
\usepackage[colorlinks=true,linkcolor=black,urlcolor=black]{hyperref}

\title{Typografie a publikování\,--\,1. projekt}
\author{Josef Kuchař\\\href{mailto:xkucha28@stud.fit.vutbr.cz}{xkucha28@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
Čím více \texttt{druhů}, \emph{řezů}, {\tiny velikostí}, \textcolor{green}{barev} písma a \textcolor{blue}{\textsc{jiných efektů}} \underline{použijeme}, \textcolor{red}{tím profesionálněji} bude {\fontfamily{pzc}\selectfont dokument} vypadat.
Čtenář tím bude \textbf{\Huge vždy nadšen!}
\end{quotation}


\textsc{Tímto pravidlem se \underline{nesmíte nikdy řídit.}}
Příliš časté zvýrazňování textových elementů a změny {\scriptsize velikosti} písma jsou známkou \textbf{amatérismu autora} a působí {\ttfamily velmi rušivě}.
